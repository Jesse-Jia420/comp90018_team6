...
public class AvailableFriendList extends ArrayAdapter {
    ...
    public AvailableFriendList(Activity context, ArrayList<String> names, ArrayList<String> distances,
                               ArrayList<Integer> imageId) {
        super(context, R.layout.available_friend_list_row_item, names);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
            row = inflater.inflate(R.layout.available_friend_list_row_item, null, true);
